...
source = replaceExact(
  ...
  "warningDismissed:!1,orientationShown:!1,waterReflectionSeen:!1,waterReflectionFullscreenSeen:!1,cycle:1",
  1,
...
let immersiveForumComponent = replaceExact(
  forumComponent,
...
immersiveForumComponent = replaceExact(
  immersiveForumComponent,
  "!e.waterReflectionSeen&&!u",
  "!e.waterReflectionFullscreenSeen&&!u",
  1,
  "versioned whole-page water event state",
);
immersiveForumComponent = replaceExact(
  immersiveForumComponent,
  'e.waterReflectionSeen?"水面以上 [已读]":"水面以上 [只读]"',
  'e.waterReflectionFullscreenSeen?"水面以上 [已读]":"水面以上 [只读]"',
  1,
  "versioned whole-page water event label",
);
...
source = replaceExact(
  ...
  '"forum"===e.tab&&(0,r.jsx)(en,{game:e,onOpen:Z,onWaterSeen:()=>q({waterReflectionSeen:!0,waterReflectionFullscreenSeen:!0})})',
  1,
